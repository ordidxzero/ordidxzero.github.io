...
## Many open problems remain. Let’s dig in.

기술이 아무리 발전해도 세상엔 아직 풀지 못한 문제가 많다고 생각합니다. 더 빠른 모델, 더 큰 파라미터, 더 화려한 어플리케이션이 쏟아져도 여전히 느리고 비싸고 불안정한 부분이 남아 있습니다. 그래서 저는 유행을 따라가기보다, 이런 남아 있는 문제들을 정면으로 바라보고 하나씩 풀어가보고자 합니다.